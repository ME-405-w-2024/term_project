...
//    }
    ...
    void StepperDriver::setAcceleration(int accelDeg){ //input is deg/s^2
    ...
    void StepperDriver::setDeceleration(int decelDeg){
    ...
    void StepperDriver::calculateMoveProfile(){
        ...
        currentSpeedPulse = (float) ((TIMER_CLOCK)*0.676) * sqrt(2.0/accelVal);
